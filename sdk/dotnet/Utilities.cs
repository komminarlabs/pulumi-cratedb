...
namespace KomminarLabs.CrateDB
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("KomminarLabs.CrateDB.version.txt");
    ...
    internal sealed class CrateDBResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public CrateDBResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
