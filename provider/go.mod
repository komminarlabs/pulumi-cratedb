module github.com/komminarlabs/pulumi-cratedb/provider
...
replace (
	...
	github.com/komminarlabs/terraform-provider-cratedb/shim => ./shim
)

require (
	github.com/komminarlabs/terraform-provider-cratedb/shim v0.0.0
...
require (
	...
	github.com/komminarlabs/terraform-provider-cratedb v0.2.0 // indirect
